...
public class SoundController : Singleton<SoundController>
{
    ...
    void Update()
    {
        m_MusicSources[1 - m_MusicIndex].volume = Mathf.Lerp(0.0f, m_MusicVolume, m_TransitionTime * Time.deltaTime);
        m_MusicSources[m_MusicIndex].volume = Mathf.Lerp(m_MusicVolume, 0.0f, m_TransitionTime * Time.deltaTime);
    }
    ...
    public void PlayMusic(AudioClip clip)
    {
        ...
        m_MusicSources[m_MusicIndex].volume = m_MusicVolume;
    }
    ...
    public void StopAllSounds()
    {
        ...
        {
            //m_SoundFXSources[i] = gameObject.AddComponent<AudioSource>();
            m_SoundFXSources[i].Stop();
            m_SoundFXSources[i].clip = null;
        }
